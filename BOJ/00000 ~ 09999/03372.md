## 아이디어
Big Integer, Dynamic Programming  
  
dfs 완전 탐색에 DP를 적용시키되  
큰 수를 저장할 수 있는 DP 테이블이여야 한다  
  
테이블을 입력하고 dp 테이블을 초기화한다  
```cpp
int N, arr[100][100];
BigInt dp[100][100];
...
```
BigInt 라이브러리를 구글링해 복붙 사용[(참고)](https://pkiop.tistory.com/107)
```cpp
# include <iostream>
# include <cstdint>
# include <cstring>
